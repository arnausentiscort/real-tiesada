      ...
      events: {
        ...
        goals: [
          { time: "18:01", type: "favor", scorer: "Chengzhi Li", assist: "Ivan Mico", goalkeeper: null,
            zone: "B5", shotPos: { x: 558, y: 174 }, assistPos: { x: 80, y: 155 }, conductPos: { x: 308, y: 138 }, goalPos: { x: 65, y: 189 }, notes: "Ivan de cap li pasa a Chenghi que marca un golas rapid e inesperat." },
          { time: "15:25", type: "contra", goalkeeper: "Ivan Mico", notes: "Ivan intenta agafarla en les mans se li escapa li fots una pilotada a la panxa a roi i ens marquen." },
          { time: "18:43", type: "contra", goalkeeper: "Ivan Mico", notes: "Robo mesopotamic, falta clarisima a Paco." },
          { time: "33:20", type: "contra", goalkeeper: "Ivan Mico", notes: "Nois el primer pal al corner, estem dormits." },
          { time: "34:00", type: "contra", goalkeeper: "Pau Ibañez", notes: "Contra dos contra un i a sobre Pau era el proter, res a fer." },
          { time: "35:50", type: "contra", goalkeeper: "Pau Ibañez", notes: "Arnau porta un tobogant de sabates i poc mes a dir ja que Paco es un videocamera amateur." },
          { time: "9:15", type: "favor", scorer: "Marc Farreras", assist: "Chengzhi Li", goalkeeper: null,
            zone: "B4", shotPos: { x: 525, y: 141 }, assistPos: { x: 264, y: 128 }, conductPos: { x: 210, y: 88 }, goalPos: { x: 25, y: 192 }, notes: "El porter rival surt en pilota Chenghi li treu i marc marca en porteria buida." },
        ],
        retransmissio: [
