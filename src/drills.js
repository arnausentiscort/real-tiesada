...
export const DRILLS = [
...

  {
    ...
    steps: [
      ...
      {
        note: 'La rep el central esquerre. El seu punta ja no hi arriba i tapa la tornada al porter, així que ha de saltar el seu mig de banda — i quan salta, deixa l\'esquena buida. El MC ataca el vertical per fora i el MD BAIXA uns metres: venint a buscar-la, la diagonal s\'obre.',
        dur: 1500, hold: 3400,
        own:    [[50,88],[12,76],[70,74],[20,28],[24,52],[46,58],[78,44]],
        rivals: [[50,6],[26,24],[66,24],[16,60],[40,46],[66,38],[40,74]],
        ball:   [14,74],
        highlight: [4,5],
      ...
      },
      {
        ...
        dur: 1500, hold: 3400,
        own:    [[50,88],[30,74],[88,76],[22,44],[54,58],[76,52],[80,28]],
        rivals: [[50,6],[34,24],[74,24],[34,38],[60,46],[84,60],[60,74]],
        ball:   [86,74],
        highlight: [4,5],
