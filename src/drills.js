...
export const DRILLS = [
...

  {
    ...
    summary: 'Quan recuperem, el 2-3-1 defensiu es transforma: els centrals s\'obren fins a la banda i baixen, el DAV estira el camp i el MI puja a dalt. Queda un 2-2-2 amb el MC i el MD junts pel mig. Som tres contra el seu punta, i per arribar-nos han de saltar amb un mig — el forat que deixa és el nostre.',
    keys: [
      ...
      'El MC i el MD van junts i pel centre, no oberts: són els que han de rebre entre línies',
    ...
    steps: [
      ...
      },
      {
        ...
        dur: 1800, hold: 3200,
        own:    [[50,90],[12,78],[88,78],[22,32],[42,58],[58,58],[78,32]],
      ...
      {
        note: 'La rep el central esquerre. Per arribar-hi han de saltar amb el seu mig de banda — i quan salta, deixa l\'esquena buida. El MC va al vertical per fora i el MD a la diagonal per dins.',
        dur: 1500, hold: 3400,
        own:    [[50,88],[12,76],[70,74],[20,28],[24,52],[48,48],[76,42]],
        rivals: [[50,6],[26,24],[66,24],[16,60],[44,40],[66,38],[38,56]],
        ball:   [14,74],
        highlight: [4,5],
        zone: { cx: 26, cy: 44, r: 13, label: 'forat del que salta' },
        arrows: [
          { from: [24,52], to: [22,44], type: 'run', label: 'vertical per fora' },
          { from: [48,48], to: [40,44], type: 'run', label: 'diagonal per dins' },
          { from: [70,74], to: [62,72], type: 'run', label: 'ajuda' },
          { from: [76,42], to: [74,48], type: 'run', label: 'baixa' },
        ],
      },
      {
        ...
        dur: 1600, hold: 2800,
        own:    [[50,88],[20,74],[88,76],[22,30],[40,54],[58,54],[76,34]],
      ...
      {
        note: 'Exactament el mateix reflectit: salta el seu altre mig, el MD ofereix el vertical per la seva banda i el MC entra a la diagonal. Ajuda el DFE i baixa el MI.',
        dur: 1500, hold: 3400,
        own:    [[50,88],[30,74],[88,76],[24,42],[52,48],[76,52],[80,28]],
        rivals: [[50,6],[34,24],[74,24],[34,38],[56,40],[84,60],[62,56]],
        ball:   [86,74],
        highlight: [4,5],
        zone: { cx: 74, cy: 44, r: 13, label: 'forat del que salta' },
        arrows: [
          { from: [76,52], to: [78,44], type: 'run', label: 'vertical per fora' },
          { from: [52,48], to: [60,44], type: 'run', label: 'diagonal per dins' },
          { from: [30,74], to: [38,72], type: 'run', label: 'ajuda' },
          { from: [24,42], to: [26,48], type: 'run', label: 'baixa' },
        ],
      },
      {
