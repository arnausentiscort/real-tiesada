...
export const DRILLS = [
...

  {
    ...
    keys: [
      ...
      'El que va a la banda s\'hi posa de debò, quasi a la mateixa altura del central: així la passada li entra gairebé vertical per la línia, al forat que ha deixat el mig que ha saltat',
      ...
      'El seu mig centre només pot marcar-ne un dels dos. Al canvi de banda ha de deixar el que tenia i agafar l\'altre — i aquest canvi de marca sempre arriba tard. És allà on s\'obre la diagonal: no a la primera, a la segona',
    ...
    steps: [
      ...
      {
        note: '2-2-2 format. El seu punta ve a pressionar el porter i es posa entre els dos centrals — però és ell sol contra tres. Amb un cop d\'ull ja hi ha un central lliure: la pilota surt cap allà.',
        dur: 1800, hold: 3200,
      ...
      {
        note: 'La rep el central esquerre. El punta ja no hi arriba i tapa la tornada al porter, així que salta el seu mig de banda. El MC se\'n va a la BANDA, quasi a la mateixa altura del central: la passada li entra gairebé vertical, al forat que acaba de deixar. El MD baixa per dins, però el seu mig centre el té marcat.',
        dur: 1500, hold: 3400,
        own:    [[50,88],[12,76],[70,74],[20,28],[17,50],[46,58],[78,44]],
        rivals: [[50,6],[26,24],[66,24],[24,64],[44,50],[66,38],[40,74]],
        ball:   [14,74],
        highlight: [4,5],
        zone: { cx: 20, cy: 42, r: 12, label: 'forat del que salta' },
        arrows: [
          { from: [17,50], to: [16,43], type: 'run', label: 'busca la banda' },
          { from: [14,74], to: [17,52], type: 'pass', label: 'quasi vertical' },
          { from: [46,58], to: [42,66], type: 'run', label: 'baixa, però marcat' },
          { from: [70,74], to: [62,72], type: 'run', label: 'ajuda' },
          { from: [78,44], to: [76,50], type: 'run' },
        ],
      },
      {
        note: 'Si no s\'obre res, canvi al central de l\'altra banda. Ara el seu punta ha de creuar tot el camp corrent darrere la pilota i el mig que havia saltat ha de tornar: aquí és on es fan tard.',
        dur: 1600, hold: 2800,
      ...
      {
        note: 'Ara al revés: el MD se\'n va a la banda i el MC entra per dins. I aquí és on els guanyem — el seu mig centre ha de canviar de marca, deixar el d\'abans i agafar el MC. Aquest canvi sempre arriba tard: la diagonal queda oberta.',
        dur: 1500, hold: 3400,
        own:    [[50,88],[30,74],[88,76],[22,44],[54,58],[83,50],[80,28]],
        rivals: [[50,6],[34,24],[74,24],[34,38],[64,44],[80,66],[60,74]],
        ball:   [86,74],
        highlight: [4,5],
        zone: { cx: 80, cy: 42, r: 12, label: 'forat del que salta' },
        arrows: [
          { from: [83,50], to: [84,43], type: 'run', label: 'busca la banda' },
          { from: [54,58], to: [58,66], type: 'run', label: 'baixa per dins' },
